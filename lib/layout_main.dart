...
class _LayoutMainState extends State<LayoutMain> {
  final List<Map<String, String>> products = [
    {'title': 'School Bag', 'price': 'Price 1100', 'image': 'assets/bag2.png'},
    {'title': 'School Bag', 'price': 'Price 1000', 'image': 'assets/bag1.jpg'},
    {'title': 'School Bag', 'price': 'Price 100', 'image': 'assets/bag2.png'},
    {'title': 'School Bag', 'price': 'Price 100', 'image': 'assets/bag1.jpg'},
    {'title': 'School Bag', 'price': 'Price 100', 'image': 'assets/bag2.png'},
    {'title': 'School Bag', 'price': 'Price 1000', 'image': 'assets/bag1.jpg'},
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveLayout(
      mobile: Scaffold(
        appBar: AppBar(
          title: const Text('Prime Shoppee'),
          titleSpacing: 0.0,

          leading: const Icon(
            Icons.abc_sharp,
            color: Colors.greenAccent, // Accent color for the dummy logo
            size: 28,
          ),
      ...
      desktop: Scaffold(
        ...
        body: Row(
          children: [
            // Permanent fully expanded Left Panel Menu for Web View profiles
            Container(
              width: 240,
              color: Colors.grey.shade50,
              child: _buildAppDrawer(isPermanent: true),
            ),
            const VerticalDivider(thickness: 1, width: 1),
            Expanded(
              flex: 3,
              child: Column(
                children: [
                  _filterDrawer(isMobile: false),
                  if (_isFilterPanelOpen) _filterProducts(isMobile: false),
                  Expanded(flex: 4, child: _cardcontents(deviceType: "Web")),
                ],
              ),
            ),
            const VerticalDivider(thickness: 1, width: 1),
            // Right Context Detail/Notification bar specific to Desktop views
            // Expanded(
            //   flex: 1,
            //   child: Container(
            ...
            //     child: const Center(
            //       child: Text('Activity Feed / Notifications Panel'),
            //     ),
            //   ),
            // ),
          ],
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  _isFilterPanelOpen ? '  Product filter' : '  Product filter',
                  style: const TextStyle(
                    color: Colors.black,
                    fontWeight: FontWeight.bold,
                  ),
  ...
  Widget _cardcontents({required String deviceType}) {
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return InkWell(
          // onTap: () {
          // Navigate to the product details screen, passing the selected item's data
          // Navigator.push(
          // context,
          // MaterialPageRoute(
                        ...
                        children: const [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              ...
                              decorationColor:
                                  Colors.red, // Optional: Changes line color
                              decorationThickness:
